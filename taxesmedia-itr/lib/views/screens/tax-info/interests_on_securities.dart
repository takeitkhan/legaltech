...
class InterestsOnSecuritiesScreen extends HookWidget {
  const InterestsOnSecuritiesScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GradientScaffold(
      appBar: TransparentAppBar(
        title: AppLocalizations.of(context)!.interests_on_security,
      ),
      body: SafeArea(
        child: Padding(
