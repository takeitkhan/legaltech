  ...
  <section id="dashboard-ecommerce" class="mt-5">
    <div class="d-flex justify-content-center flex-column align-items-center mt-1 mb-2">
      <h3 style="color: #8176f1; font-weight: bold" class="mt-2">
        Organization Name,Address & Business Identification Number
      </h3>
      <p>Sales Accounts Book</p>
      <p>[See clauses (a) of Sub-Rules 40 and clause (a) of Rule 41]</p>
    </div>
        ...
        <table class="table table-bordered" style="width: 100%">
          <thead>
            <tr>
              ...
              <th colspan="3">Buyer/Supply Receipent</th>
              <th colspan="2">Challan Details</th>
              <th colspan="5">Sold/Supplied Goods Description</th>
              <th colspan="2">Closing Balance of Material</th>
            </tr>
            <tr>
              <!-- for opening balance  -->
              <th>Qty(Unit)</th>
              ...
              <!-- total Produced goods/service  -->
              <th>Qty(Unit)</th>
              <th>Value</th>
              <!-- (Excluding all type of taxes) -->
              <!-- end of total Produced goods/service  -->

              <!-- Buyer/Supply Receipent  -->
              <th>Name</th>
              <th>Address</th>
              <th>Registration Enlist/National ID NO</th>
              <!-- end of Buyer/supply Receipent  -->

              <!--challan details  -->
              <th>Number</th>
              <th>Date</th>
              <!-- end of challan  details -->
