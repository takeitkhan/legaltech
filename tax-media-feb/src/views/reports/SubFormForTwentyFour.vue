  ...
  data() {
    return {
      columns: [
        ...
        { label: "Supplier's BIN", field: 'bin' },
        { label: "Supplier's Name", field: 'contact_name' },
        { label: "Supplier's Address", field: 'contact_address' },
        { label: 'Value', field: 'value' },
        { label: 'Deducted VAT', field: 'vat' },
        { label: 'Invoice No.(Challan/Bill No. etc)', field: 'invoice_no' },
        { label: 'Invoice/Challan/Bill Date', field: 'transaction_date' },
        { label: 'VAT Duduction at Source Certificate No.', field: 'certification_no' },
        { label: 'VAT Deduction at Source Certificate Date', field: 'certification_date' },
        {
          label: 'Tax Deposit Serial Number of Bank Transfer',
          field: 'tax_deposit_serial_number_of_bank_transfer',
        },
        { label: 'Tax Deposit Date', field: 'tax_deposit_date' },
