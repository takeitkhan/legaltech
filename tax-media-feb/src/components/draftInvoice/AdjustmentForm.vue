  ...
  <article>
    <div class="row ">
      ...
      <div class="form-group col-8">
        ...
        >
        <p
          v-if="Object.keys(errors).length > 0 && errors.title"
    ...
    <div class="row">
      <div class="form-group col-6">
        ...
        >
        <p
          v-if="Object.keys(errors).length > 0 && errors.amount"
          class="text-danger font-weight-bold my-1 "
      ...
      <div class="form-group col-6 mb-1">
        ...
        />
        <p
          v-if="Object.keys(errors).length > 0 && errors.vat_rate"
          class="text-danger font-weight-bold my-1 "
          v-text="errors.vat_rate[0]"
        />
      </div>
      <div class="form-group col-6">
        <label
        ...
        >
        <p
          v-if="Object.keys(errors).length > 0 && errors.adjustment_date"
          class="text-danger font-weight-bold my-1 "
          v-text="errors.adjustment_date[0]"
        />
      </div>
      <div class="form-group col-6">
        <label
        ...
        <p
          v-if="Object.keys(errors).length > 0 && errors.adjustment_type"
          class="text-danger font-weight-bold my-1 "
          v-text="errors.adjustment_type[0]"
        />
      </div>
    </div>
  </article>
